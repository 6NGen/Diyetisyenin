  ...
  return (
    ...
    >
      <a
        ...
        className="flex items-center justify-center gap-2 border-t border-sea-900 bg-sea-700 px-4 py-3.5 font-mono text-label tracking-[0.18em] text-white uppercase"
      >
      <svg
        aria-hidden="true"
        viewBox="0 0 24 24"
